...
public class ModItems {
    // if adding item then add the item here and you can define the stuff about it here
    ...
    public static final Item RUBY_STAFF = registerItem("ruby_staff",
            new Item(new FabricItemSettings().maxCount(1))); //max count 1 meaning that it will only stack up to 1 item meaning no 64 items in one slot
//TOOLS SECTION
// The value after modtoolmaterial.ruby, are for attackdamage and then attackspeed
